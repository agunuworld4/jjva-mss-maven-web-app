...
pipeline {
  ...
  environment {
    ...
    NEXUS_REPOSITORY = "jjva-mss-maven-web-app"
  ...
  stages {
    stage('Cloning Git') {
            steps {
                ...
                git credentialsId: 'GIT_CREDENTIALS', url:  'https://github.com/agunuworld4/jjva-mss-maven-web-app.git',branch: 'labMasterBranch'
            }
        }
   ...
   //hardcoded in pom.xml file
    ...
    stage ('SonarQubeReports') {
      ...
      //       -Dsonar.token=${jjva_mvn_sonar_token}"
         }
     }
